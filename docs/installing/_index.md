...
Alternatively, use our up-to-date [container image](https://github.com/flatcar/container-linux-config-transpiler/pkgs/container/ct): `docker run --rm -i ghcr.io/flatcar/ct:latest`.
