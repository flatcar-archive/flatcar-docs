...
The Ignition specification 3.3.0 is the latest version supported in Fedora CoreOS but Flatcar Container Linux does not support v3 configs yet (until the update to Ignition v2.12.0 is done).
