...
```tf
module "aws-tempest" {
  source = "git::https://github.com/kinvolk/lokomotive-kubernetes//aws/container-linux/kubernetes"
...
```tf
...
source = "git:https://github.com/kinvolk/lokomotive-kubernetes//aws/container-linux/kubernetes?ref=hash"
```
