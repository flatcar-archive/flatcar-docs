...
The update service is an optional hosted service provided by CoreOS and is not included in a standard CoreOS Container Linux cluster. Head over to the [Update Service](https://coreos.com/products/coreupdate/) page for more details.
